App = {
  ...
  reloadArticles: function() {
    ...
    App.contracts.ChainList.deployed().then(function(instance) {
      ...
      console.log("This is the price in reloadArticles ", price);
      ...
      if(buyer == App.account){
        // if connected user is the buyer
        buyer = "You";
      } else if (buyer == 0x0) {
        buyer = "No one yet";
      }
  ...
  buyArticle: function() {
    event.preventDefault(); // small trick to avoid issues
    // retrieve the article Price, data attr in button
    console.log("This is the incoming event.target data", $(event.target).data('value'));
    var _price = parseFloat($(event.target).data('value'));
    console.log("This is the incoming price ", _price);
